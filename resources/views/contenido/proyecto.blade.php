            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class?="widget-body">
                                         <form method="POST" action="/prueba" class="form-horizontal">
                                         {{ csrf_field() }}
                                            <div class="form-group row d-flex align-items-center mb-5">
                                                <label class="col-lg-3 form-control-label">Id. Manager</label>
                                                <div class="col-lg-9">
                                                    <input type="text" name="id_manager" class="form-control" placeholder="Id. Proyecto">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row d-flex align-items-center mb-5">
                                                ...
                                                <div class="col-lg-9">
                                                    <input type="text" name="id_cliente" placeholder="id_cliente" class="form-control">
                                                </div>
                                            </div>
                                            <div class="form-group row d-flex align-items-center mb-5">
                                            ...
                                            <div class="form-group row d-flex align-items-center mb-5">
                                                ...
                                                <div class="col-lg-9">
                                                    <input type="date" name="fecha_inicio" placeholder="fecha_inicio" class="form-control">
                                                </div>
                                            </div>
                                            <div class="form-group row d-flex align-items-center mb-5">
                                                <label class="col-lg-3 form-control-label">Fecha Vencimiento</label>
                                                <div class="col-lg-9">
                                                    <input type="date" name="fecha_vencimiento" placeholder="fecha_vencimiento" class="form-control">
                                                </div>
                                            </div>
                                            <div class="form-group row d-flex align-items-center mb-5">
                                                <label class="col-lg-3 form-control-label">Pago Total</label>
                                                <div class="col-lg-9">
                                                    <input type="text" name="pago_total" placeholder="pago_total" class="form-control">
                                                </div>
                                            </div>
                                            <div class="form-group row d-flex align-items-center mb-5">
